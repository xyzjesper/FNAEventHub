  ...
  return (
    <>
      ...
      <div suppressHydrationWarning className="mt-10">
        <p className="ml-16 text-center mx-auto text-xl font-semibold">
          ...
          <p className="ml-32 mt-6 mb-12 bg-gradient-to-br to-yellow-300 via-red-600 from-orange-500 bg-clip-text text-transparent selection:text-gray-700 dark:selection:text-white/90 ">
